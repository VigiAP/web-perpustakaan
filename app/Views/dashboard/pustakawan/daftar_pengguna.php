            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="<?= base_url('pustakawan/tambah_pengguna') ?>" class="btn btn-primary float-right">Tambah Pengguna</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        ...
                        <table id="petugasTable" class="table table-bordered table-hover">
                            ...
                            <?php foreach ($users as $user): ?>
                                    <tr>
                                        ...
                                        <td><?= $user['no_hp']; ?></td>
                                        <td>
                                            <a href="<?= base_url('/pustakawan/edit_pengguna/' . $user['id_users']); ?>" class="btn btn-info btn-sm"><i class="nav-icon fa fa-pencil-alt"></i> Edit</a>
                                            <a href="<?= base_url('/pustakawan/delete_pengguna/' . $user['id_users']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this item?')"><i class="nav-icon fa fa-trash"></i> Delete</a>
